...
pub const exported_nifs = [_]e.ErlNifFunc{
    // Font loading
    .{ .name = "get_font_default", .arity = 0, .fptr = core.nif_wrapper(nif_get_font_default), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "get_font_default", .arity = 1, .fptr = core.nif_wrapper(nif_get_font_default), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font", .arity = 1, .fptr = core.nif_wrapper(nif_load_font), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font", .arity = 2, .fptr = core.nif_wrapper(nif_load_font), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_ex", .arity = 4, .fptr = core.nif_wrapper(nif_load_font_ex), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_ex", .arity = 5, .fptr = core.nif_wrapper(nif_load_font_ex), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_from_image", .arity = 3, .fptr = core.nif_wrapper(nif_load_font_from_image), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_from_image", .arity = 4, .fptr = core.nif_wrapper(nif_load_font_from_image), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_from_memory", .arity = 5, .fptr = core.nif_wrapper(nif_load_font_from_memory), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "load_font_from_memory", .arity = 6, .fptr = core.nif_wrapper(nif_load_font_from_memory), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
    .{ .name = "is_font_valid", .arity = 1, .fptr = core.nif_wrapper(nif_is_font_valid), .flags = e.ERL_NIF_DIRTY_JOB_CPU_BOUND },
};
...
fn nif_get_font_default(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
...
fn nif_load_font(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
...
fn nif_load_font_ex(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
    ...
    var arg_codepoints = core.ArgumentArray(core.Int, core.Int.data_type, rl.allocator).get(env, argv[2]) catch {
    ...
    const font_type = core.Int.get(env, argv[3]) catch {
        return error.invalid_argument_font_type;
    };
...
fn nif_load_font_from_image(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
    ...
    const arg_key = core.Argument(core.Color).get(env, argv[1]) catch {
        return error.invalid_argument_key;
    };
    defer arg_key.free();
    const key = arg_key.data;

    const first_char = core.Int.get(env, argv[2]) catch {
        return error.invalid_argument_first_char;
    };
...
fn nif_load_font_from_memory(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
    ...
    const font_size = core.Int.get(env, argv[2]) catch {
        return error.invalid_argument_font_size;
    };

    var arg_codepoints = core.ArgumentArray(core.Int, core.Int.data_type, rl.allocator).get(env, argv[3]) catch {
        return error.invalid_argument_codepoint;
    };
    defer arg_codepoints.free();
    const codepoints = arg_codepoints.data;
    ...
    const font_type = core.Int.get(env, argv[4]) catch {
        return error.invalid_argument_font_type;
    };
...
fn nif_is_font_valid(env: ?*e.ErlNifEnv, argc: c_int, argv: [*c]const e.ErlNifTerm) !e.ErlNifTerm {
    assert(argc == 1);
