  ...
  describe "resource conversion" do
    defp dataset_resource_conversion(_) do
      datasets = %{
        ...
        wave: {"wave", :base},
        audio_info: {"audio_info", :base},
        audio_stream: {"audio_stream", :base},
        sound: {"sound", :base},
        sound_alias: {"sound_alias", :base},
        sound_stream: {"sound_stream", :base},
        sound_stream_alias: {"sound_stream_alias", :base},
        music: {"music", :base},
        ...
        audio_info_empty: {"audio_info", :empty},
        audio_stream_empty: {"audio_stream", :empty},
        sound_empty: {"sound", :empty},
        sound_alias_empty: {"sound_alias", :empty},
        sound_stream_empty: {"sound_stream", :empty},
        sound_stream_alias_empty: {"sound_stream_alias", :empty},
    ...
    parameterized_test "", %{datasets: datasets}, [
      ...
      [dataset: :sound],
      [dataset: :sound_alias],
      [dataset: :sound_stream],
      [dataset: :sound_stream_alias],
      [dataset: :music],
      ...
      [dataset: :wave_empty],
      [dataset: :audio_info_empty],
      [dataset: :audio_stream_empty],
      [dataset: :sound_empty],
      [dataset: :sound_alias_empty],
      [dataset: :sound_stream_empty],
      [dataset: :sound_stream_alias_empty],
      [dataset: :music_empty],
