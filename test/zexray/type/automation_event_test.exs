defmodule Zexray.Type.AutomationEventTest.Type2 do
  defstruct [
    :frame,
    :type,
    :params
...
defmodule Zexray.Type.AutomationEventTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.AutomationEvent

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.AutomationEvent, as: Type
  alias Zexray.Type.AutomationEventTest.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: automation_event_fixture()
    }
  end
