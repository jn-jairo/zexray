defmodule Zexray.Type.RectangleTest.Type2 do
  defstruct [
    :x,
    :y,
    :width,
...
defmodule Zexray.Type.RectangleTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Rectangle

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Rectangle, as: Type
  alias Zexray.Type.RectangleTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: rectangle_fixture()
    }
  end
