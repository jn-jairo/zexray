defmodule Zexray.Type.IVector2Test.Type2 do
  defstruct [
    :x,
    :y
  ]
...
defmodule Zexray.Type.IVector2Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.IVector2

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.IVector2, as: Type
  alias Zexray.Type.IVector2Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: ivector2_fixture()
    }
  end
