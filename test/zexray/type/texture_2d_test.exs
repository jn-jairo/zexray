defmodule Zexray.Type.Texture2DTest.Type2 do
  defstruct [
    :id,
    :width,
    :height,
...
defmodule Zexray.Type.Texture2DTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Texture2D

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Texture2D, as: Type
  alias Zexray.Type.Texture2DTest.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: texture_2d_fixture()
    }
  end
