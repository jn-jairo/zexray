defmodule Zexray.Type.IVector4Test.Type2 do
  defstruct [
    :x,
    :y,
    :z,
...
defmodule Zexray.Type.IVector4Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.IVector4

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.IVector4, as: Type
  alias Zexray.Type.IVector4Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: ivector4_fixture()
    }
  end
