defmodule Zexray.Type.UIVector4Test.Type2 do
  defstruct [
    :x,
    :y,
    :z,
...
defmodule Zexray.Type.UIVector4Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.UIVector4

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.UIVector4, as: Type
  alias Zexray.Type.UIVector4Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: uivector4_fixture()
    }
  end
