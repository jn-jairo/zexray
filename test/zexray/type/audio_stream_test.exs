defmodule Zexray.Type.AudioStreamTest.Type2 do
  defstruct [
    :buffer,
    :processor,
    :sample_rate,
...
defmodule Zexray.Type.AudioStreamTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.AudioStream

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.AudioStream, as: Type
  alias Zexray.Type.AudioStreamTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: audio_stream_fixture()
    }
  end
