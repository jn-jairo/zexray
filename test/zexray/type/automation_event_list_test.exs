defmodule Zexray.Type.AutomationEventListTest.Type2 do
  defstruct [
    :capacity,
    :count,
    :events
...
defmodule Zexray.Type.AutomationEventListTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.AutomationEventList

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.AutomationEventList, as: Type
  alias Zexray.Type.AutomationEventListTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: automation_event_list_fixture()
    }
  end
