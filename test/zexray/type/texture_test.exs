defmodule Zexray.Type.TextureTest.Type2 do
  defstruct [
    :id,
    :width,
    :height,
...
defmodule Zexray.Type.TextureTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Texture

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Texture, as: Type
  alias Zexray.Type.TextureTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: texture_fixture()
    }
  end
