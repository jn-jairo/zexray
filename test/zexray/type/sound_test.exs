defmodule Zexray.Type.SoundTest.Type2 do
  defstruct [
    :stream,
    :frame_count
  ]
...
defmodule Zexray.Type.SoundTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Sound

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Sound, as: Type
  alias Zexray.Type.SoundTest.Type2
