defmodule Zexray.Type.MusicTest.Type2 do
  defstruct [
    :stream,
    :frame_count,
    :looping,
...
defmodule Zexray.Type.MusicTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Music

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Music, as: Type
  alias Zexray.Type.MusicTest.Type2
