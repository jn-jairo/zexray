defmodule Zexray.Type.RenderTextureTest.Type2 do
  defstruct [
    :id,
    :texture,
    :depth
...
defmodule Zexray.Type.RenderTextureTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.RenderTexture

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.RenderTexture, as: Type
  alias Zexray.Type.RenderTextureTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: render_texture_fixture()
    }
  end
