defmodule Zexray.Type.ImageTest.Type2 do
  defstruct [
    :data,
    :width,
    :height,
...
defmodule Zexray.Type.ImageTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Image

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Image, as: Type
  alias Zexray.Type.ImageTest.Type2
