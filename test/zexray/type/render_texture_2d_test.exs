defmodule Zexray.Type.RenderTexture2DTest.Type2 do
  defstruct [
    :id,
    :texture,
    :depth
...
defmodule Zexray.Type.RenderTexture2DTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.RenderTexture2D

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.RenderTexture2D, as: Type
  alias Zexray.Type.RenderTexture2DTest.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: render_texture_2d_fixture()
    }
  end
