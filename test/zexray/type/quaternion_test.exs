defmodule Zexray.Type.QuaternionTest.Type2 do
  defstruct [
    :x,
    :y,
    :z,
...
defmodule Zexray.Type.QuaternionTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Quaternion

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Quaternion, as: Type
  alias Zexray.Type.QuaternionTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: quaternion_fixture()
    }
  end
