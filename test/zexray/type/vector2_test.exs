defmodule Zexray.Type.Vector2Test.Type2 do
  defstruct [
    :x,
    :y
  ]
...
defmodule Zexray.Type.Vector2Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.Vector2

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.Vector2, as: Type
  alias Zexray.Type.Vector2Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: vector2_fixture()
    }
  end
