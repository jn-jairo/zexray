defmodule Zexray.Type.BoundingBoxTest.Type2 do
  defstruct [
    :min,
    :max
  ]
...
defmodule Zexray.Type.BoundingBoxTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.BoundingBox

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.BoundingBox, as: Type
  alias Zexray.Type.BoundingBoxTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: bounding_box_fixture()
    }
  end
