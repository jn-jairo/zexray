defmodule Zexray.Type.BoneInfoTest.Type2 do
  defstruct [
    :name,
    :parent
  ]
...
defmodule Zexray.Type.BoneInfoTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.BoneInfo

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.BoneInfo, as: Type
  alias Zexray.Type.BoneInfoTest.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: bone_info_fixture()
    }
  end
