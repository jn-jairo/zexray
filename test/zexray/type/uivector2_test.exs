defmodule Zexray.Type.UIVector2Test.Type2 do
  defstruct [
    :x,
    :y
  ]
...
defmodule Zexray.Type.UIVector2Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.UIVector2

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.UIVector2, as: Type
  alias Zexray.Type.UIVector2Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: uivector2_fixture()
    }
  end
