defmodule Zexray.Type.FilePathListTest.Type2 do
  defstruct [
    :capacity,
    :count,
    :paths
...
defmodule Zexray.Type.FilePathListTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.FilePathList

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.FilePathList, as: Type
  alias Zexray.Type.FilePathListTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: file_path_list_fixture()
    }
  end
