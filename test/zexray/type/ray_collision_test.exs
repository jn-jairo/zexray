defmodule Zexray.Type.RayCollisionTest.Type2 do
  defstruct [
    :hit,
    :distance,
    :point,
...
defmodule Zexray.Type.RayCollisionTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.RayCollision

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.RayCollision, as: Type
  alias Zexray.Type.RayCollisionTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: ray_collision_fixture()
    }
  end
