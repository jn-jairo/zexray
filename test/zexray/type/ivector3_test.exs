defmodule Zexray.Type.IVector3Test.Type2 do
  defstruct [
    :x,
    :y,
    :z
...
defmodule Zexray.Type.IVector3Test do
  use ExUnit.Case, async: true
  doctest Zexray.Type.IVector3

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.IVector3, as: Type
  alias Zexray.Type.IVector3Test.Type2

  import Zexray.Util, only: [map_from_struct: 1]

  setup_all _ do
    %{
      value: ivector3_fixture()
    }
  end
