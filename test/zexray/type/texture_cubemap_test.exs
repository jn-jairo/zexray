defmodule Zexray.Type.TextureCubemapTest.Type2 do
  defstruct [
    :id,
    :width,
    :height,
...
defmodule Zexray.Type.TextureCubemapTest do
  use ExUnit.Case, async: true
  doctest Zexray.Type.TextureCubemap

  import ExUnitParameterize

  import Zexray.TypeFixture

  alias Zexray.Type.TextureCubemap, as: Type
  alias Zexray.Type.TextureCubemapTest.Type2

  import Zexray.Util, only: [map_from_struct: 1, similar?: 2]

  setup_all _ do
    %{
      value: texture_cubemap_fixture()
    }
  end
