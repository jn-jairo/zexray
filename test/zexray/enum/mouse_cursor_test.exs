defmodule Zexray.Enum.MouseCursorTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.MouseCursor

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.MouseCursor, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = mouse_cursor_fixture()
