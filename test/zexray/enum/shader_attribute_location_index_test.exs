defmodule Zexray.Enum.ShaderAttributeLocationIndexTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.ShaderAttributeLocationIndex

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.ShaderAttributeLocationIndex, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = shader_attribute_location_index_fixture()
