defmodule Zexray.Enum.ShaderUniformDataTypeTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.ShaderUniformDataType

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.ShaderUniformDataType, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = shader_uniform_data_type_fixture()
