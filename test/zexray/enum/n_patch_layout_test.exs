defmodule Zexray.Enum.NPatchLayoutTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.NPatchLayout

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.NPatchLayout, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = n_patch_layout_fixture()
