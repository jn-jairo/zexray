defmodule Zexray.Enum.GamepadAxisTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.GamepadAxis

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.GamepadAxis, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = gamepad_axis_fixture()
