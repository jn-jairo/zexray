defmodule Zexray.Enum.ShaderLocationIndexTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.ShaderLocationIndex

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.ShaderLocationIndex, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = shader_location_index_fixture()
