defmodule Zexray.Enum.GamepadButtonTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.GamepadButton

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.GamepadButton, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = gamepad_button_fixture()
