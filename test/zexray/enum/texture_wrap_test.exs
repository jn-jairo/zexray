defmodule Zexray.Enum.TextureWrapTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.TextureWrap

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.TextureWrap, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = texture_wrap_fixture()
