defmodule Zexray.Enum.MouseButtonTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.MouseButton

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.MouseButton, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = mouse_button_fixture()
