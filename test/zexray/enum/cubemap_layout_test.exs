defmodule Zexray.Enum.CubemapLayoutTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.CubemapLayout

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.CubemapLayout, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = cubemap_layout_fixture()
