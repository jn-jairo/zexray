defmodule Zexray.Enum.MaterialMapIndexTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.MaterialMapIndex

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.MaterialMapIndex, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = material_map_index_fixture()
