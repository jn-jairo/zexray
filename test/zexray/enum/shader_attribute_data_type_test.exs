defmodule Zexray.Enum.ShaderAttributeDataTypeTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.ShaderAttributeDataType

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.ShaderAttributeDataType, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = shader_attribute_data_type_fixture()
