defmodule Zexray.Enum.CameraProjectionTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.CameraProjection

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.CameraProjection, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = camera_projection_fixture()
