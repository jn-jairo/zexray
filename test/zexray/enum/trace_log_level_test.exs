defmodule Zexray.Enum.TraceLogLevelTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.TraceLogLevel

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.TraceLogLevel, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = trace_log_level_fixture()
