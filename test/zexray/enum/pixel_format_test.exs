defmodule Zexray.Enum.PixelFormatTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.PixelFormat

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.PixelFormat, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = pixel_format_fixture()
