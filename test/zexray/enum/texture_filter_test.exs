defmodule Zexray.Enum.TextureFilterTest do
  use ExUnit.Case, async: true
  doctest Zexray.Enum.TextureFilter

  import ExUnitParameterize

  import Zexray.EnumFixture

  alias Zexray.Enum.TextureFilter, as: Type

  describe "value" do
    defp dataset_value(_) do
      %{value: value, name: name} = texture_filter_fixture()
